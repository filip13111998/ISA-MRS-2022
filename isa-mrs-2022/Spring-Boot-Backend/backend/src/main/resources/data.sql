...
INSERT INTO my_user (id,username, password, first_name, last_name, email, enabled, last_password_reset_date) VALUES (nextval('cust_seq_user'),'myus2', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'Nikola', 'Nikolic', 'admin@example.com', true, '2017-10-01 18:57:58.508-07');
...
INSERT INTO cottage (name,address,longitude,latitude,description,number_of_room,number_of_bed_per_room,rule_behaviour,more_information,delete_ctg) VALUES ('Lea Aggg2','Street Lea',23.3556,23.7777 , 'Description 2grfgf',4,7,'rule behaviour','more informations',false);
...
--BOAT
INSERT INTO boat (name,type_boat,lenght,engine_num,engine_power,max_speed,adress,longitude,latitude,capacity,description,navigation,rule_behaviour,fishing_equipment,more_information,delete_bt) VALUES ('baot 1','type1',5,2,200,230,'adr1',23.3333,54.2222,'capacity 1','description1','navitagtion1','rule_behaviour1','fishing_eqp1','more_info1',false);
INSERT INTO boat (name,type_boat,lenght,engine_num,engine_power,max_speed,adress,longitude,latitude,capacity,description,navigation,rule_behaviour,fishing_equipment,more_information,delete_bt) VALUES ('baot 2','type2',5,3,300,330,'adr2',23.3333,54.2222,'capacity 2','description2','navitagtion2','rule_behaviour2','fishing_eqp2','more_info2',false);
INSERT INTO boat (name,type_boat,lenght,engine_num,engine_power,max_speed,adress,longitude,latitude,capacity,description,navigation,rule_behaviour,fishing_equipment,more_information,delete_bt) VALUES ('baot 3','type3',9,3,200,130,'adr3',23.3333,54.2222,'capacity 3','description3','navitagtion3','rule_behaviour3','fishing_eqp3','more_info3',false);
INSERT INTO boat (name,type_boat,lenght,engine_num,engine_power,max_speed,adress,longitude,latitude,capacity,description,navigation,rule_behaviour,fishing_equipment,more_information,delete_bt) VALUES ('baot 4','type4',7,6,100,440,'adr4',23.3333,54.2222,'capacity 4','description4','navitagtion4','rule_behaviour4','fishing_eqp4','more_info4',false);
INSERT INTO boat (name,type_boat,lenght,engine_num,engine_power,max_speed,adress,longitude,latitude,capacity,description,navigation,rule_behaviour,fishing_equipment,more_information,delete_bt) VALUES ('baot 5','type5',9,4,500,40,'adr5',23.3333,54.2222,'capacity 5','description5','navitagtion5','rule_behaviour5','fishing_eqp5','more_info5',false);
INSERT INTO boat (name,type_boat,lenght,engine_num,engine_power,max_speed,adress,longitude,latitude,capacity,description,navigation,rule_behaviour,fishing_equipment,more_information,delete_bt) VALUES ('baot 6','type6',3,4,500,450,'adr6',23.3333,54.2222,'capacity 6','description6','navitagtion6','rule_behaviour6','fishing_eqp6','more_info6',false);
INSERT INTO boat (name,type_boat,lenght,engine_num,engine_power,max_speed,adress,longitude,latitude,capacity,description,navigation,rule_behaviour,fishing_equipment,more_information,delete_bt) VALUES ('baot 7','type7',4,7,210,200,'adr7',23.3333,54.2222,'capacity 7','description7','navitagtion7','rule_behaviour7','fishing_eqp7','more_info7',false);
INSERT INTO boat (name,type_boat,lenght,engine_num,engine_power,max_speed,adress,longitude,latitude,capacity,description,navigation,rule_behaviour,fishing_equipment,more_information,delete_bt) VALUES ('baot 8','type8',15,6,220,230,'adr8',23.3333,54.2222,'capacity 8','description8','navitagtion8','rule_behaviour8','fishing_eqp8','more_info8',false);
INSERT INTO boat (name,type_boat,lenght,engine_num,engine_power,max_speed,adress,longitude,latitude,capacity,description,navigation,rule_behaviour,fishing_equipment,more_information,delete_bt) VALUES ('baot 9','type9',15,3,330,230,'adr9',23.3333,54.2222,'capacity 9','description9','navitagtion9','rule_behaviour9','fishing_eqp9','more_info9',false);
INSERT INTO boat (name,type_boat,lenght,engine_num,engine_power,max_speed,adress,longitude,latitude,capacity,description,navigation,rule_behaviour,fishing_equipment,more_information,delete_bt) VALUES ('baot 10','type10',25,1,300,130,'adr10',23.3333,54.2222,'capacity 10','description10','navitagtion10','rule_behaviour10','fishing_eqp10','more_info10',false);
INSERT INTO boat (name,type_boat,lenght,engine_num,engine_power,max_speed,adress,longitude,latitude,capacity,description,navigation,rule_behaviour,fishing_equipment,more_information,delete_bt) VALUES ('baot 11','type11',6,2,200,230,'adr11',23.3333,54.2222,'capacity 11','description11','navitagtion11','rule_behaviour11','fishing_eqp11','more_info11',false);
INSERT INTO boat (name,type_boat,lenght,engine_num,engine_power,max_speed,adress,longitude,latitude,capacity,description,navigation,rule_behaviour,fishing_equipment,more_information,delete_bt) VALUES ('baot 12','type12',11,2,100,530,'adr12',23.3333,54.2222,'capacity 12','description12','navitagtion12','rule_behaviour12','fishing_eqp12','more_info12',false);
...
--ADVENTURE COMPLAINT
INSERT INTO adventure_complaint(description,my_user_id,adventure_id) VALUES ('opsi zalbe' , 5,1);

--INSTRUCTOR COMPLAINT
INSERT INTO instructor_complaint(description,my_user_id,instructor_id) VALUES ('opsi zalbe' , 5,1);
...
--BOAT COMPLAINT
INSERT INTO boat_complaint(description,my_user_id,boat_id) VALUES ('opsi zalbe' , 6,2);

--BOAT OWNER COMPLAINT
INSERT INTO boat_owner_complaint(description,my_user_id,boat_owner_id) VALUES ('opsi zalbe' , 6,1);
...
--MY USER ADVENTURES
INSERT INTO adventure_my_users(adventure_id,my_users_id) VALUES (1,5);

--MY USER BOATS
INSERT INTO boat_my_users(boat_id,my_users_id) VALUES (2,6);

--MY USER COTTAGES
INSERT INTO cottage_my_users(cottage_id,my_users_id) VALUES (2,5);