...
--USERS
INSERT INTO administrator (id,deactivate,activate_acc,username, password, first_name, last_name, email, enabled, last_password_reset_date) VALUES (nextval('cust_seq_user'),true,true,'adm1', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'Marko', 'Markovic', 'admin1mail@example.com', true, '2017-10-01 21:58:58.508-07');
INSERT INTO administrator (id,deactivate,activate_acc,username, password, first_name, last_name, email, enabled, last_password_reset_date) VALUES (nextval('cust_seq_user'),true,false,'admin2', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'Nikola', 'Nikolic', 'admin@example.com', true, '2017-10-01 18:57:58.508-07');
...
--COTTAGE
INSERT INTO cottage (name,address,longitude,latitude,description,number_of_room,number_of_bed_per_room,rule_behaviour,more_information,delete_ctg,version) VALUES ('Brea Cottage','Wilson 4',23.3556,23.7777 , 'Description 2332',4,3,'rule behaviour','more informations',false,0);
INSERT INTO cottage (name,address,longitude,latitude,description,number_of_room,number_of_bed_per_room,rule_behaviour,more_information,delete_ctg,version) VALUES ('Swiiss','Street 21' ,23.3556,23.7777, 'Description 212',4,3,'rule behaviour','more informations',false,0);
INSERT INTO cottage (name,address,longitude,latitude,description,number_of_room,number_of_bed_per_room,rule_behaviour,more_information,delete_ctg,version) VALUES ('Lea Araptment','Street Lea',23.3556,23.7777 , 'Description 2grfgf',4,3,'rule behaviour','more informations',false,0);
INSERT INTO cottage (name,address,longitude,latitude,description,number_of_room,number_of_bed_per_room,rule_behaviour,more_information,delete_ctg,version) VALUES ('Brea 2','Wilson 51',23.3556,23.7777 , 'Description 2wqee',4,6,'rule behaviour','more informations',false,0);
INSERT INTO cottage (name,address,longitude,latitude,description,number_of_room,number_of_bed_per_room,rule_behaviour,more_information,delete_ctg,version) VALUES ('Brea ','Wilson 4' ,23.3556,23.7777, 'Description 2332',3,4,'rule behaviour','more informations',false,0);
INSERT INTO cottage (name,address,longitude,latitude,description,number_of_room,number_of_bed_per_room,rule_behaviour,more_information,delete_ctg,version) VALUES ('Swiiss 22','Street 21',23.3556,23.7777 , 'Description 212',5,3,'rule behaviour','more informations',false,0);
INSERT INTO cottage (name,address,longitude,latitude,description,number_of_room,number_of_bed_per_room,rule_behaviour,more_information,delete_ctg,version) VALUES ('Lea Dep','Street Lea' ,23.3556,23.7777, 'Description 2grfgf',5,2,'rule behaviour','more informations',false,0);
INSERT INTO cottage (name,address,longitude,latitude,description,number_of_room,number_of_bed_per_room,rule_behaviour,more_information,delete_ctg,version) VALUES ('Brea Corp','Wilson 51' ,23.3556,23.7777, 'Description 2wqee',2,2,'rule behaviour','more informations',false,0);
INSERT INTO cottage (name,address,longitude,latitude,description,number_of_room,number_of_bed_per_room,rule_behaviour,more_information,delete_ctg,version) VALUES ('A','Wilson 4',23.3556,23.7777 , 'Description 2332',4,3,'rule behaviour','more informations',false,0);
INSERT INTO cottage (name,address,longitude,latitude,description,number_of_room,number_of_bed_per_room,rule_behaviour,more_information,delete_ctg,version) VALUES ('B','Street 21' ,23.3556,23.7777, 'Description 212',4,1,'rule behaviour','more informations',false,0);
INSERT INTO cottage (name,address,longitude,latitude,description,number_of_room,number_of_bed_per_room,rule_behaviour,more_information,delete_ctg,version) VALUES ('C','Street Lea',23.3556,23.7777 , 'Description 2grfgf',4,7,'rule behaviour','more informations',false,0);
INSERT INTO cottage (name,address,longitude,latitude,description,number_of_room,number_of_bed_per_room,rule_behaviour,more_information,delete_ctg,version) VALUES ('D','Wilson 51',23.3556,23.7777 , 'Description 2wqee',4,3,'rule behaviour','more informations',false,0);
...
--ADVENTURE
INSERT INTO adventure (name,delete_av,address,longitude,latitude,description,instructor_id , max_num , rule_behaviour,more_information,cancellation_conditions) VALUES ('put u dolinu' ,false, 'Novi Sad' , 23.3344 ,12.3232,'opsi neki',1,15,'pravila ponasanja','more information','uslovi otkaza');
INSERT INTO adventure (name,delete_av,address,longitude,latitude,description,instructor_id , max_num , rule_behaviour,more_information,cancellation_conditions) VALUES ('planinski pogled' ,false, 'Nis' , 55.444 ,23.2277,'opsi neki',1,10,'pravila ponasanja','more information','uslovi otkaza');
INSERT INTO adventure (name,delete_av,address,longitude,latitude,description,instructor_id , max_num , rule_behaviour,more_information,cancellation_conditions) VALUES ('dan na reci' ,false, 'Beograd' , 88.554 ,84.4521,'opsi neki',1,12,'pravila ponasanja','more information','uslovi otkaza');
INSERT INTO adventure (name,delete_av,address,longitude,latitude,description,instructor_id , max_num , rule_behaviour,more_information,cancellation_conditions) VALUES ('dan na reci 2' ,false, 'Novi Sad' , 88.554 ,84.4521,'opsi neki',1,12,'pravila ponasanja','more information','uslovi otkaza');
INSERT INTO adventure (name,delete_av,address,longitude,latitude,description,instructor_id , max_num , rule_behaviour,more_information,cancellation_conditions) VALUES ('recni adn' ,false, 'Beograd' , 88.554 ,84.4521,'opsi neki',1,8,'pravila ponasanja','more information','uslovi otkaza');
INSERT INTO adventure (name,delete_av,address,longitude,latitude,description,instructor_id , max_num , rule_behaviour,more_information,cancellation_conditions) VALUES ('dan na reci 4' , false,'Beograd' , 88.554 ,84.4521,'opsi neki',1,15,'pravila ponasanja','more information','uslovi otkaza');
