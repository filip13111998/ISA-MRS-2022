...
@Component({
  selector: 'app-boat-admin-page',
  templateUrl: './boat-admin-page.component.html',
  styleUrls: ['./boat-admin-page.component.css']
})
export class BoatAdminPageComponent implements OnInit {
  ...
  public delete(id: number): any {
    this.bs.delete(id).subscribe((b: Boolean) => {
